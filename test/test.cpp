...
int main()
{
	...
	scryptPositions(id, 0, LABELS_COUNT - 1, 8, salt, SPACEMESH_API_CUDA, out[1], 512, 1, 1);
	scryptPositions(id, 0, LABELS_COUNT - 1, 8, salt, SPACEMESH_API_OPENCL, out[2], 512, 1, 1);
